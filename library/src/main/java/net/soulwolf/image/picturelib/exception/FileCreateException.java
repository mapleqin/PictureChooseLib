...
/**
 * author: Soulwolf Created on 2015/7/13 21:52.
...
public class FileCreateException extends RuntimeException {
    ...
    public FileCreateException(String detailMessage, Throwable throwable) {
        super(detailMessage, throwable);
    }

    public FileCreateException(Throwable throwable) {
        super(throwable);
    }
}
